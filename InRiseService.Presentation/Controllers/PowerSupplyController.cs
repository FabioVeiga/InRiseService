...
namespace InRiseService.Presentation.Controllers
{
    ...
    public class PowerSupplyController : ControllerBase
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> GetFiltered([FromQuery] PowerSupplyFilterDto request)
        {
            try
            {
               var result = await _powerSupplyService.GetByFilterAsync(request);
                ...
                {
                    var mappedResponse = _mapper.Map<PowerSupplyDtoResponse>(item);
                    mappedResponse.Images = await _imageService.GetByPowerSupplyIdAsync(item.Id);
                }
